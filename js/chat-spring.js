...
var BlossomScene = /** @class */ (function () {
    ...
    BlossomScene.prototype.resetPetal = function (petal) {
        ...
        petal.y = petal.el.offsetHeight * -3;
    ...
    BlossomScene.prototype.updatePetal = function (petal) {
        ...
        var t = 'translateX( ' + petal.x + 'px ) translateY( ' + (petal.y+250) + 'px ) translateZ( ' + petal.z + 'px )  rotate' + petal.rotation.axis + '( ' + petal.rotation.value + 'deg )';
